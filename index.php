...
// object with API key
$rofex = new phpRofex('infoinnobite7580','oarndD7$');

// $token = $rofex->get_token('https://api.remarkets.primary.com.ar/auth/getToken');

// var_dump($token);

$data = $rofex->get_marketdata('https://api.remarkets.primary.com.ar/rest/marketdata/get?marketId=ROFX&symbol=SOJ.ROS/NOV22&entries=SE,CL');
